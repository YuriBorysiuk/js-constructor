...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var html = this.value.map(_utils.col).join(''); // что бы убрать запятые - метод join, т.к метод map возвращает массив 
      //и при выводе массива в сторочку он соединяется запятыми
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9354" + '/');
